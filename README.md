## YOLOV7-Tiny：You Only Look Once目标检测模型在keras当中的实现
---
...
## Top News
**`2022-10`**:**仓库创建，支持step、cos学习率下降法、支持adam、sgd优化器选择、支持学习率根据batch_size自适应调整、新增图片裁剪、支持多GPU训练、支持各个种类目标数量计算、支持heatmap。**  
...
## 文件下载
训练所需的权值可在百度网盘中下载。  
链接: https://pan.baidu.com/s/1xw0ZWDm5UKpeeOpyQuWtlg     
提取码: gec5     
